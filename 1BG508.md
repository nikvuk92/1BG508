...
Finally, after you've merged all the reference datasets, we need to merge in the Unkowns as well. To do this, as previously, filter out the A/T & C/G SNPs and merge, flip and exclude (if you have to). 
