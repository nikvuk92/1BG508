...
*Advice - it might be easier for you if all your datasets to be in the same directory (.bed +.bim +.fam files for all four, instead of having to go in and out of the different folders).
