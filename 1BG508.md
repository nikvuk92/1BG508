...
```
/proj/uppmax2023-2-1/1BG508_2023/  
```
...
For this part of the exercize copy the files from ```/proj/uppmax2023-2-1/1BG508_2023/2_POPULATION_STRUCTURE_INFERENCE/2_PCA``` to your directory.
...
```
scp YOUR_USERNAME@rackham.uppmax.uu.se:/crex/proj/uppmax2023-2-1/1BG508_2023/YOUR_DIRECTORY/PopStrucIn1_PCA1.pdf . 
```
