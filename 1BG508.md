# Populationgenomik 1BG508 [2024 Version]
...
- There is an UPPMAX project and its name is UPPMAX 2024/2-4;
...
```
/proj/uppmax2024-2-4/1BG508_2024/  
```
...
Ex.:
 ```
    interactive -A uppmax2024-2-4 -M snowy -p node -n 32 -t 02:00:00
 ```
### Moving about:
```
    cd – change directory
...
For this part of the exercize copy the files from ```/proj/uppmax2024-2-4/1BG508_2024/2_POPULATION_STRUCTURE_INFERENCE/2_PCA``` to your directory.
...
```
scp YOUR_USERNAME@rackham.uppmax.uu.se:/crex/proj/uppmax2024-2-4/1BG508_2024/YOUR_DIRECTORY/PopStrucIn1_PCA1.pdf . 
```
