...
### A.2 Merging to the Unknown to the RefInd1
...
So our first step will be merging with a fake reference (RefInd1) that we prepared form SNP info data beforehand:
...
### A.4 Remember to extract your fake (RefInd1) from your data
